...
$destination="uploads/".$new_image_proposal;
...
$destination="uploads/".$new_image_ring;
...
// creating ession for preview
 $user_data = array(
        'user-name'=>$user_name,
        'user-id'=>$user_id,
        'wedding-month'=>$wedding_month,
        'wedding-date'=>$wedding_date,
        'wedding-year'=>$wedding_year,
        'wedding-location'=>$wedding_location,
        'wedding-person'=>$wedding_person,
        'wedding-hour'=>$wedding_hour,
        'wedding-minute'=>$wedding_min,
...
// It will destroy the session if it was created by the user for preview
...
<div class="form-main-div">
	...
	<div class="inner-texts">
		...
		<ul>
			<li><input type="text" name="wedding-month" placeholder="Month" value="<?php echo $_SESSION['user-preview']['wedding-month'];?>" required="required"></li>
			<li><input type="text" name="wedding-date" placeholder="Date" value="<?php echo $_SESSION['user-preview']['wedding-date'];?>" required="required"></li>
    ...
    <div><p>Proposal Picture:</p>
    	<span id="name-span">
    </span><br><label class="custom-file-upload">
    <input type="file" id="proposal-img" accept="image/*" name="proposal-pic" style="display: none;" />Browse</label></div>
		<div><p>Ring Picture:</p>
			<span id="name-span2">
    </span><br><label class="custom-file-upload">
    <input type="file" id="ring-img" accept="image/*" name="ring-pic" style="display: none;" />Browse</label></div>
	...
	<div class="wedding-submit">
		<input type="submit" id="preview-input" name="couple-preview" value="Preview">
		<input type="submit" id="submit-input"  name="couple-submit" value="Submit">
	</div>
		</form>
	</div> 
</div>
