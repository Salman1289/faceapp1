...
if(isset($_SESSION['user-preview'])){
	...
	$wedding_minute = $_SESSION['user-preview']['wedding-minute'];
	...
	$user_name = $_SESSION['user-preview']['user-name'];
	 ...
	 $a = array("wedding-month"=>$wedding_month,"wedding-date"=>$wedding_date, "wedding-year"=>$wedding_year,"wedding-hour"=>$wedding_hour,"wedding-minute"=>$wedding_minute,"user-id"=>$user_id,"shared-person-id"=>$wedding_person,"wedding-location"=>$wedding_location,"user-name" =>$user_name);
    array_push($data, $a);
}else{
